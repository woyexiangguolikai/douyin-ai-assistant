...
| 文档 | 内容 |
|------|------|
| [01-PRD.md](docs/01-PRD.md) | 产品需求文档：用户场景、功能清单、优先级 |
| [02-design.md](docs/02-design.md) | 设计文档：架构、UI/数据库设计 |
| [03-development.md](docs/03-development.md) | 开发文档：技术栈、项目结构、启动方式 |
| [04-changelog.md](docs/04-changelog.md) | 更新日志：版本历史、修复记录 |
